...
urlpatterns = [
    ...
    path('posts/<int:pk>/comment/update/', CommentUpdateView.as_view(), name='comment-update'),
    path('posts/<int:pk>/comment/delete/', CommentDeleteView.as_view(), name='comment-delete'),
