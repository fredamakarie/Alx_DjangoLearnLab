...
from .views import (
    ...
    PostCreateView, PostUpdateView, PostDeleteView, CommentCreateView, CommentDeleteView, CommentUpdateView, SearchResultsView, TagListView, LoginView, LogoutView, SignUpView, ProfileUpdateView, PostByTagListView
)
